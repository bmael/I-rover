...
# Generated by qmake (2.01a) (Qt 4.8.3) on: jeu. déc. 13 07:59:30 2012
# Project:  I-rover.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/I-rover1.0.0/ && $(COPY_FILE) --parents confdefs.h config.h ui_commanddialog.h ui_newmapdialog.h ui_newtilesetdialog.h ui_objectpropertiesdialog.h ui_offsetmapdialog.h ui_preferencesdialog.h ui_propertiesdialog.h ui_resizedialog.h ui_saveasimagedialog.h lib/pugixml_sources/pugiconfig.hpp lib/pugixml_sources/pugixml.hpp src/ihm/mainwindow.h src/robot/actuator.h src/robot/movementactuator.h src/robot/robot.h src/robot/sensor.h src/ihm/widgets/aboutdialog.h src/ihm/widgets/leftmenu.h src/ihm/widgets/mapmenu.h src/ihm/widgets/mission.h src/ihm/widgets/robotinformation.h src/ihm/widgets/robotmenu.h src/map/Map/background.h src/map/Map/cell.h src/map/Map/field.h src/map/Map/layers.h src/map/Map/map.h src/map/Map/objectLayers.h src/map/Map/obstacle.h src/robot/actuators/arms.h src/robot/actuators/rocketlauncher.h src/robot/sensors/gps.h src/robot/sensors/proximity.h src/map/controleur/headers/gestionnaireMap.h src/map/controleur/headers/mapFactory.h src/map/controleur/headers/parseur.h src/map/tileset/headers/tileSet.h src/map/tileset/headers/tileSetImage.h src/robot/actuators/movementactuator/chains.h src/robot/actuators/movementactuator/wheels.h .tmp/I-rover1.0.0/ && $(COPY_FILE) --parents src/ihm/resources.qrc .tmp/I-rover1.0.0/ && $(COPY_FILE) --parents qrc_tiled.cpp lib/pugixml_sources/pugixml.cpp src/ihm/main.cpp src/ihm/mainwindow.cpp src/robot/actuator.cpp src/robot/movementactuator.cpp src/robot/robot.cpp src/robot/sensor.cpp src/ihm/widgets/aboutdialog.cpp src/ihm/widgets/leftmenu.cpp src/ihm/widgets/mapmenu.cpp src/ihm/widgets/mission.cpp src/ihm/widgets/robotinformation.cpp src/ihm/widgets/robotmenu.cpp src/map/Map/background.cpp src/map/Map/cell.cpp src/map/Map/field.cpp src/map/Map/layers.cpp src/map/Map/map.cpp src/map/Map/objectLayers.cpp src/map/Map/obstacle.cpp src/robot/actuators/arms.cpp src/robot/actuators/rocketlauncher.cpp src/robot/sensors/gps.cpp src/robot/sensors/proximity.cpp src/map/controleur/sources/gestionnaireMap.cpp src/map/controleur/sources/mapFactory.cpp src/map/controleur/sources/parseur.cpp src/map/tileset/sources/tileSet.cpp src/map/tileset/sources/tileSetImage.cpp src/robot/actuators/movementactuator/chains.cpp src/robot/actuators/movementactuator/wheels.cpp .tmp/I-rover1.0.0/ && $(COPY_FILE) --parents src/ihm/mainwindow.ui src/ihm/widgets/aboutdialog.ui src/ihm/widgets/leftmenu.ui src/ihm/widgets/mapmenu.ui src/ihm/widgets/mission.ui src/ihm/widgets/robotinformation.ui src/ihm/widgets/robotmenu.ui .tmp/I-rover1.0.0/ && (cd `dirname .tmp/I-rover1.0.0` && $(TAR) I-rover1.0.0.tar I-rover1.0.0 && $(COMPRESS) I-rover1.0.0.tar) && $(MOVE) `dirname .tmp/I-rover1.0.0`/I-rover1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/I-rover1.0.0
...
qrc_tiled.o: qrc_tiled.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_tiled.o qrc_tiled.cpp
