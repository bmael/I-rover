...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Dec 12 11:46:16 2012
# Project:  I-rover.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile I-rover.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I. -Isrc/ihm -Isrc/ihm/widgets -Isrc/robot -Isrc/robot/actuators -Isrc/map/Map -Isrc/map/tileset/headers -Isrc/map/controleur/headers -Isrc/map/lib/pugixml_sources -Isrc/robot/actuators/movementactuator -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: I-rover.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile I-rover.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/I-rover1.0.0/ && $(COPY_FILE) --parents confdefs.h config.h src/ihm/mainwindow.h src/robot/actuator.h src/robot/movementactuator.h src/robot/robot.h src/robot/sensor.h src/ihm/widgets/aboutdialog.h src/ihm/widgets/leftmenu.h src/ihm/widgets/mapmenu.h src/ihm/widgets/mission.h src/ihm/widgets/robotinformation.h src/ihm/widgets/robotmenu.h src/map/Map/background.h src/map/Map/cell.h src/map/Map/field.h src/map/Map/layers.h src/map/Map/map.h src/map/Map/objectLayers.h src/map/Map/obstacle.h src/robot/actuators/arms.h src/robot/actuators/rocketlauncher.h src/map/controleur/headers/gestionnaireMap.h src/map/controleur/headers/mapFactory.h src/map/controleur/headers/parseur.h src/map/lib/pugixml_sources/pugiconfig.hpp src/map/lib/pugixml_sources/pugixml.hpp src/map/tileset/headers/tileSet.h src/map/tileset/headers/tileSetImage.h src/robot/actuators/movementactuator/chains.h src/robot/actuators/movementactuator/wheels.h .tmp/I-rover1.0.0/ && $(COPY_FILE) --parents src/ihm/resources.qrc .tmp/I-rover1.0.0/ && $(COPY_FILE) --parents src/ihm/main.cpp src/ihm/mainwindow.cpp src/robot/actuator.cpp src/robot/movementactuator.cpp src/robot/robot.cpp src/robot/sensor.cpp src/ihm/widgets/aboutdialog.cpp src/ihm/widgets/leftmenu.cpp src/ihm/widgets/mapmenu.cpp src/ihm/widgets/mission.cpp src/ihm/widgets/robotinformation.cpp src/ihm/widgets/robotmenu.cpp src/map/Map/background.cpp src/map/Map/cell.cpp src/map/Map/field.cpp src/map/Map/layers.cpp src/map/Map/map.cpp src/map/Map/objectLayers.cpp src/map/Map/obstacle.cpp src/robot/actuators/arms.cpp src/robot/actuators/rocketlauncher.cpp src/map/controleur/sources/gestionnaireMap.cpp src/map/controleur/sources/mapFactory.cpp src/map/controleur/sources/parseur.cpp src/map/lib/pugixml_sources/pugixml.cpp src/map/tileset/sources/tileSet.cpp src/map/tileset/sources/tileSetImage.cpp src/robot/actuators/movementactuator/chains.cpp src/robot/actuators/movementactuator/wheels.cpp .tmp/I-rover1.0.0/ && $(COPY_FILE) --parents src/ihm/mainwindow.ui src/ihm/widgets/aboutdialog.ui src/ihm/widgets/leftmenu.ui src/ihm/widgets/mapmenu.ui src/ihm/widgets/mission.ui src/ihm/widgets/robotinformation.ui src/ihm/widgets/robotmenu.ui .tmp/I-rover1.0.0/ && (cd `dirname .tmp/I-rover1.0.0` && $(TAR) I-rover1.0.0.tar I-rover1.0.0 && $(COMPRESS) I-rover1.0.0.tar) && $(MOVE) `dirname .tmp/I-rover1.0.0`/I-rover1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/I-rover1.0.0
